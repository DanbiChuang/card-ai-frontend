    ...
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(to bottom, #4F4F4F 0%, #000000 100%)" }}>
      <div className="max-w-4xl mx-auto p-6">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-white mb-2">確認名片資訊</h1>
          <p className="text-blue-100">請檢查並修正 AI 解讀的名片資訊</p>
          
          {/* AI處理狀態指示器 */}
          {cardData.aiProcessed && (
            <div className="mt-3 inline-flex items-center px-3 py-1" style={{ background: '#8B8B8B', color: 'white', borderRadius: '9999px', fontSize: '0.875rem' }}>
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="flex items-center">
            ...
            <div className="text-blue-600 font-medium ml-2 text-blue-100">確認資訊</div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">名片圖片</h3>
            <div className="border rounded-lg p-4 bg-gray-50">
              ...
              />
              <div className="hidden text-center text-blue-200">
                <p>圖片載入失敗</p>
          ...
          {/* 編輯區域 */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">名片資訊</h3>
            <div className="space-y-4">
              <div>
        ...
        <div className="mt-8 flex justify-center space-x-4">
          <button
            ...
            className="px-6 py-3 border border-blue-200 text-blue-100 rounded-lg hover:bg-blue-900 transition-colors"
          >
            重新上傳
          </button>
          <button
